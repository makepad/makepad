...
pub struct DataBindingsForApp {
    ...
    inumber: i32,
    #[live]
    dropdown: DropDownEnum,
    #[live]
    dropdown_below: DropDownEnum,
    #[live]
    dropdown_disabled: DropDownEnum,
    #[live]
    dropdown_customized: DropDownEnum,
    #[live]
    dropdown_flat: DropDownEnum,
    #[live]
    dropdown_flat_below: DropDownEnum,
    #[live]
    dropdown_gradient_x: DropDownEnum,
    #[live]
    dropdown_gradient_x_below: DropDownEnum,
    #[live]
    dropdown_gradient_y: DropDownEnum,
    #[live]
    dropdown_gradient_y_below: DropDownEnum,
}
...
impl MatchEvent for App {
    fn handle_actions(&mut self, cx: &mut Cx, actions: &Actions) {
        ...
        for slider in [
            ...
            (
                ids!(theme_font_size_contrast),
                live_id!(THEME_FONT_SIZE_CONTRAST),
            ),
...
impl App {
    pub fn data_bind(mut db: DataBindingMap) {
        ...
        db.bind(
            ids!(dropdown_gradient_x_below),
            ids_array!(dropdown_gradient_x_below),
        );
        db.bind(ids!(dropdown_gradient_y), ids_array!(dropdown_gradient_y));
        db.bind(
            ids!(dropdown_gradient_y_below),
            ids_array!(dropdown_gradient_y_below),
        );
    }
}
