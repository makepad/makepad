...
impl App {
    ...
    // called automatically by the initialization code we generated with the call to the macro
    // `main_app` above. The `makepad_widgets::live_design` function is generated by the call to the
    // macro `live_design` above.
    pub fn live_design(cx: &mut Cx) {
        makepad_widgets::live_design(cx);
    }

    // This function is used to handle any incoming events from the host system. It is called
    // automatically by the initialization code we generated with the call to the macro `main_app`
    // above.
