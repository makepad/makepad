...
// A very simple example of a Makepad application, used to illustrate the basic concepts of Makepad.
// It consists of both a button and a label displaying a counter. Clicking the button will increment
// the counter.
...
impl App {
    ...
    // The `makepad_widgets::live_design` function is generated by the call to the macro
    // `live_design` above.
