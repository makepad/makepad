...
/** `WebAssembly.Instance#exports` is non-extensible in modern browsers; Makepad needs `_bridge`, `_memory`, etc. */
export function makepad_exports_shell(exports, module) {
    const mem = exports.memory;
    const hts =
        typeof SharedArrayBuffer !== "undefined" &&
        mem !== undefined &&
        mem.buffer instanceof SharedArrayBuffer;
    if (Object.isExtensible(exports)) {
        exports._module = module;
        exports._memory = mem;
        exports._has_thread_support = hts;
        return exports;
    }
    const base = {
        __proto__: null,
        ...
        _memory: mem,
        _module: module,
        _has_thread_support: hts,
    };
    // Dioxus bindgen footer checks `wasm.__wbindgen_start` / `wasm.main` on the same object as
    // `__dx_mainWasm`; forward everything else from `exports` (non-extensible).
    return new Proxy(base, {
        get(target, prop, receiver) {
            ...
            if (typeof prop === "string" || typeof prop === "number") {
                const v = target.exports[prop];
                return typeof v === "function" ? v.bind(target.exports) : v;
            }
            return undefined;
        },
        ...
        has(target, prop) {
            ...
            return typeof prop === "string" && prop in target.exports;
        },
    });
}
