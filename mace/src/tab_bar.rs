...
impl TabBar {
    ...
    pub fn set_selected_item_id(&mut self, cx: &mut Cx, tab_id: Option<TabId>) {
    ...
    pub fn handle_event(
        ...
        for action in actions {
            match action {
                list_logic::Action::ItemWasPressed(tab_id) => {
                    self.set_selected_item_id(cx, Some(tab_id));
