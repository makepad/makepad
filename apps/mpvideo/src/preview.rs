...
//!
//! A viewer started as `mpvideo --preview <path>` is not thrown away when
...
mod tests {
    ...
    fn a_warm_viewer_unloads_and_reloads() {
        ...
        assert_eq!(state.title("mpvideo"), "Preview \u{2014} one.mp4");
        ...
        assert_eq!(state.title("mpvideo"), "Preview");
        ...
        assert!(state.is_loaded());
        assert_eq!(state.title("mpvideo"), "Preview \u{2014} two.mp4");
    }
    ...
    fn a_standalone_run_keeps_the_apps_own_title() {
        ...
        assert_eq!(state.title("mpvideo"), "mpvideo \u{2014} one.mp4");
        assert_eq!(PreviewState::new(false, None).title("mpvideo"), "mpvideo");
    }
}
