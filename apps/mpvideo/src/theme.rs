...
//! publishes the five colors mpvideo's own chrome uses as `mod.mpv.*` (for
...
/// Every color mpvideo paints, as `#rrggbb` strings.
#[derive(Clone, Debug)]
pub struct Palette {
...
impl Palette {
    ...
    pub fn publish(&self, vm: &mut ScriptVm) {
        ...
        vm.eval(ScriptMod {
            ...
            module_path: "mpvideo_palette".to_string(),
