...
pub fn manifest() -> ServiceManifest {
    ...
    for (name, description, props, required, risk) in [
        ...
        ("set_mode", "Switch between Structured tabs, the tasks view, the Architecture plan and the Disk map. All four share the same live terminals and code editors; Architecture shows the cached architecture plan of the active file's crate; Disk shows the CWD volume map.", r#""mode":{"type":"string","enum":["structured","tasks","architecture","disk"]}"#, "mode", Risk::Act),
