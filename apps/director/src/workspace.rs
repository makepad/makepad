...
//! per state directory; the camera lives in makepad_workspace::camera. Documents, terminals and processes are owned by the Dock items;
//! nothing here refers to them.

use makepad_widgets::makepad_micro_serde::*;
use std::path::Path;

pub use makepad_workspace::camera::{Camera, Geometry, MAX_ZOOM, MIN_ZOOM};
...
/// with their terminals on the screen host), the Architecture plan, and Disk.
