...
//!
//! A viewer started as `pdf --preview <path>` is not thrown away when
...
mod tests {
    ...
    fn a_warm_viewer_unloads_and_reloads() {
        ...
        assert_eq!(state.title("pdf"), "Preview \u{2014} one.pdf");
        ...
        assert_eq!(state.title("pdf"), "Preview");
        ...
        assert!(state.is_loaded());
        assert_eq!(state.title("pdf"), "Preview \u{2014} two.pdf");
    }
    ...
    fn a_standalone_run_keeps_the_apps_own_title() {
        ...
        assert_eq!(state.title("pdf"), "pdf \u{2014} one.pdf");
        assert_eq!(PreviewState::new(false, None).title("pdf"), "pdf");
    }
}
