...
script_mod! {
    ...
    // `mod.mpwm_theme.shell`, and nothing at runtime reads an omarchy file.
    ...
    set_type_default() do #(ShellTokens::script_component(vm)) {
        corner_radius: mod.mpwm_theme.shell.corner_radius
        bar +: {
            background: mod.mpwm_theme.shell.bar.background
            background_alpha: mod.mpwm_theme.shell.bar.background_alpha
            text: mod.mpwm_theme.shell.bar.text
            active: mod.mpwm_theme.shell.bar.active
            size_horizontal: mod.mpwm_theme.shell.bar.size_horizontal
            size_vertical: mod.mpwm_theme.shell.bar.size_vertical
            icon_slot: mod.mpwm_theme.shell.bar.icon_slot
            icon_canvas: mod.mpwm_theme.shell.bar.icon_canvas
            icon_font: mod.mpwm_theme.shell.bar.icon_font
            status_slot: mod.mpwm_theme.shell.bar.status_slot
        }
        popups +: {
            background: mod.mpwm_theme.shell.popups.background
            background_alpha: mod.mpwm_theme.shell.popups.background_alpha
            text: mod.mpwm_theme.shell.popups.text
            border: mod.mpwm_theme.shell.popups.border
            border_end: mod.mpwm_theme.shell.popups.border_end
            border_angle: mod.mpwm_theme.shell.popups.border_angle
            border_alpha: mod.mpwm_theme.shell.popups.border_alpha
            border_width: mod.mpwm_theme.shell.popups.border_width
        }
        tooltip +: {
            background: mod.mpwm_theme.shell.tooltip.background
            background_alpha: mod.mpwm_theme.shell.tooltip.background_alpha
            text: mod.mpwm_theme.shell.tooltip.text
            border: mod.mpwm_theme.shell.tooltip.border
            border_end: mod.mpwm_theme.shell.tooltip.border_end
            border_angle: mod.mpwm_theme.shell.tooltip.border_angle
            border_alpha: mod.mpwm_theme.shell.tooltip.border_alpha
            border_width: mod.mpwm_theme.shell.tooltip.border_width
        }
        notifications +: {
            countdown: mod.mpwm_theme.shell.notifications.countdown
            surface +: {
                background: mod.mpwm_theme.shell.notifications.background
                background_alpha: mod.mpwm_theme.shell.notifications.background_alpha
                text: mod.mpwm_theme.shell.notifications.text
                border: mod.mpwm_theme.shell.notifications.border
                border_end: mod.mpwm_theme.shell.notifications.border_end
                border_angle: mod.mpwm_theme.shell.notifications.border_angle
                border_alpha: mod.mpwm_theme.shell.notifications.border_alpha
                border_width: mod.mpwm_theme.shell.notifications.border_width
            }
        }
        menu +: {
            scrim: mod.mpwm_theme.shell.menu.scrim
            scrim_alpha: mod.mpwm_theme.shell.menu.scrim_alpha
            selected_background: mod.mpwm_theme.shell.menu.selected_background
            selected_background_alpha: mod.mpwm_theme.shell.menu.selected_background_alpha
            selected_text: mod.mpwm_theme.shell.menu.selected_text
            selected_border: mod.mpwm_theme.shell.menu.selected_border
            selected_border_alpha: mod.mpwm_theme.shell.menu.selected_border_alpha
            surface +: {
                background: mod.mpwm_theme.shell.menu.background
                background_alpha: mod.mpwm_theme.shell.menu.background_alpha
                text: mod.mpwm_theme.shell.menu.text
                border: mod.mpwm_theme.shell.menu.border
                border_end: mod.mpwm_theme.shell.menu.border_end
                border_angle: mod.mpwm_theme.shell.menu.border_angle
                border_alpha: mod.mpwm_theme.shell.menu.border_alpha
                border_width: mod.mpwm_theme.shell.menu.border_width
            }
        }
        launcher +: {
            scrim: mod.mpwm_theme.shell.launcher.scrim
            scrim_alpha: mod.mpwm_theme.shell.launcher.scrim_alpha
            selected_background: mod.mpwm_theme.shell.launcher.selected_background
            selected_background_alpha: mod.mpwm_theme.shell.launcher.selected_background_alpha
            selected_text: mod.mpwm_theme.shell.launcher.selected_text
            selected_border: mod.mpwm_theme.shell.launcher.selected_border
            selected_border_alpha: mod.mpwm_theme.shell.launcher.selected_border_alpha
            surface +: {
                background: mod.mpwm_theme.shell.launcher.background
                background_alpha: mod.mpwm_theme.shell.launcher.background_alpha
                text: mod.mpwm_theme.shell.launcher.text
                border: mod.mpwm_theme.shell.launcher.border
                border_end: mod.mpwm_theme.shell.launcher.border_end
                border_angle: mod.mpwm_theme.shell.launcher.border_angle
                border_alpha: mod.mpwm_theme.shell.launcher.border_alpha
                border_width: mod.mpwm_theme.shell.launcher.border_width
            }
        }
        controls +: {
            normal_color: mod.mpwm_theme.shell.controls.normal_color
            normal_fill_alpha: mod.mpwm_theme.shell.controls.normal_fill_alpha
            normal_border: mod.mpwm_theme.shell.controls.normal_border
            normal_border_width: mod.mpwm_theme.shell.controls.normal_border_width
            normal_border_alpha: mod.mpwm_theme.shell.controls.normal_border_alpha
            hover_color: mod.mpwm_theme.shell.controls.hover_color
            hover_fill_alpha: mod.mpwm_theme.shell.controls.hover_fill_alpha
            hover_border: mod.mpwm_theme.shell.controls.hover_border
            hover_border_width: mod.mpwm_theme.shell.controls.hover_border_width
            hover_border_alpha: mod.mpwm_theme.shell.controls.hover_border_alpha
            focus_color: mod.mpwm_theme.shell.controls.focus_color
            focus_fill_alpha: mod.mpwm_theme.shell.controls.focus_fill_alpha
            focus_border: mod.mpwm_theme.shell.controls.focus_border
            focus_border_width: mod.mpwm_theme.shell.controls.focus_border_width
            focus_border_alpha: mod.mpwm_theme.shell.controls.focus_border_alpha
            selected_color: mod.mpwm_theme.shell.controls.selected_color
            selected_fill_alpha: mod.mpwm_theme.shell.controls.selected_fill_alpha
            selected_border: mod.mpwm_theme.shell.controls.selected_border
            selected_border_width: mod.mpwm_theme.shell.controls.selected_border_width
            selected_border_alpha: mod.mpwm_theme.shell.controls.selected_border_alpha
            pressed_fill_alpha: mod.mpwm_theme.shell.controls.pressed_fill_alpha
            selection_fill_alpha: mod.mpwm_theme.shell.controls.selection_fill_alpha
        }
        spacing +: {
            xxs: mod.mpwm_theme.shell.spacing.xxs
            xs: mod.mpwm_theme.shell.spacing.xs
            sm: mod.mpwm_theme.shell.spacing.sm
            md: mod.mpwm_theme.shell.spacing.md
            lg: mod.mpwm_theme.shell.spacing.lg
            xl: mod.mpwm_theme.shell.spacing.xl
            xxl: mod.mpwm_theme.shell.spacing.xxl
            xxxl: mod.mpwm_theme.shell.spacing.xxxl
            huge: mod.mpwm_theme.shell.spacing.huge
            control_gap: mod.mpwm_theme.shell.spacing.control_gap
            control_padding_x: mod.mpwm_theme.shell.spacing.control_padding_x
            control_padding_y: mod.mpwm_theme.shell.spacing.control_padding_y
            input_padding_y: mod.mpwm_theme.shell.spacing.input_padding_y
            control_height: mod.mpwm_theme.shell.spacing.control_height
            popup_row_height: mod.mpwm_theme.shell.spacing.popup_row_height
            dropdown_width: mod.mpwm_theme.shell.spacing.dropdown_width
            searchable_dropdown_width: mod.mpwm_theme.shell.spacing.searchable_dropdown_width
            number_field_width: mod.mpwm_theme.shell.spacing.number_field_width
            searchable_popup_min_height: mod.mpwm_theme.shell.spacing.searchable_popup_min_height
            row_gap: mod.mpwm_theme.shell.spacing.row_gap
            row_padding_x: mod.mpwm_theme.shell.spacing.row_padding_x
            label_gap: mod.mpwm_theme.shell.spacing.label_gap
            panel_gap: mod.mpwm_theme.shell.spacing.panel_gap
            panel_padding: mod.mpwm_theme.shell.spacing.panel_padding
            popup_padding: mod.mpwm_theme.shell.spacing.popup_padding
            gaps_out: mod.mpwm_theme.shell.spacing.gaps_out
        }
        font +: {
            base_size: mod.mpwm_theme.shell.font.base_size
            caption: mod.mpwm_theme.shell.font.caption
            body_small: mod.mpwm_theme.shell.font.body_small
            body: mod.mpwm_theme.shell.font.body
            subtitle: mod.mpwm_theme.shell.font.subtitle
            title: mod.mpwm_theme.shell.font.title
            heading: mod.mpwm_theme.shell.font.heading
            display: mod.mpwm_theme.shell.font.display
            display_large: mod.mpwm_theme.shell.font.display_large
            icon_small: mod.mpwm_theme.shell.font.icon_small
            icon: mod.mpwm_theme.shell.font.icon
            icon_large: mod.mpwm_theme.shell.font.icon_large
        }
    }
