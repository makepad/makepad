...
//! # The token contract
//!
//! At runtime the ONLY source is the splash theme: `mod.mpwm_theme.shell`,
...
/// the theme has been evaluated (the DSL below reads `mod.mpwm_theme`).
...
/// The whole `mod.mpwm_theme.shell` object.
#[derive(Clone, Copy, Debug, Script, ScriptHook)]
