//! mppdf: a PDF viewer for the mp* app family. See Cargo.toml for scope.
//!
...
/// Parse mppdf's own arguments out of `argv` (already skipping argv[0]).
///
/// Every other flag belongs to somebody else — `--remote`, `--stdin-loop`,
/// `MAKEPAD_*` switches — and is left alone, exactly as the other mp* apps
/// treat them.
