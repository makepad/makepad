...
//!
//! A viewer started as `image --preview <path>` is not thrown away when
...
mod tests {
    ...
    fn a_warm_viewer_unloads_and_reloads() {
        ...
        assert_eq!(state.title("image"), "Preview \u{2014} one.png");
        ...
        assert_eq!(state.title("image"), "Preview");
        ...
        assert!(state.is_loaded());
        assert_eq!(state.title("image"), "Preview \u{2014} two.png");
    }
    ...
    fn a_standalone_run_keeps_the_apps_own_title() {
        ...
        assert_eq!(state.title("image"), "image \u{2014} one.png");
        assert_eq!(PreviewState::new(false, None).title("image"), "image");
    }
}
