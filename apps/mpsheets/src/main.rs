//! mpsheets — a spreadsheet as a plain full-window Makepad app, part of the
//! mp* family (mpwm hosts it as a tile; mpterm, mpbrowser, mpfiles and mptask
//! are its siblings).
//!
...
//! `cargo test -p mpsheets` covers it without a window.
//!
//! mpsheets runs standalone, and unmodified inside makepad-wm / Studio tiles
