...
script_mod! {
    ...
    mod.widgets.ProcessTable = set_type_default() do mod.widgets.ProcessTableBase{
        ...
        toolbar := View{
            ...
            // The well behind the text is mp_theme's business (it flattens the
...
/// Processes the kill button refuses: the kernel, init, and mptask itself.
...
impl ProcessTable {
    ...
    pub fn apply_theme(&mut self, cx: &mut Cx, theme: Theme) {
        ...
        // No draw_bg here: mp_theme::apply already flattened every text-field
