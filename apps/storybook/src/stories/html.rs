...
script_mod! {
    ...
    mod.stories.HtmlOverview = StoryPage{
        ...
        Html{
            width: Fill height: Fit
            body: "<H1>H1 Headline</H1><H2>H2 Headline</H2><H3>H3 Headline</H3><H4>H4 Headline</H4><H5>H5 Headline</H5><H6>H6 Headline</H6>This is <b>bold</b>&nbsp;and <i>italic text</i>.<sep><b><i>Bold italic</i></b>, <u>underlined</u>, and <s>strike through</s> text. <p>This is a paragraph</p> <code>A code block</code>. <br/> And this is a <a href='https://example.com/'>link</a><br/><ul><li>lorem</li><li>ipsum</li><li>dolor</li></ul><ol><li>lorem</li><li>ipsum</li><li>dolor</li></ol><br/> <blockquote>Blockquote</blockquote> <pre>pre</pre><sub>sub</sub><del>del</del>"
        }
        ...
        Html{
            width: Fill height: Fit
            body: "<table><thead><tr><th>Element</th><th>Symbol</th><th>Notes</th></tr></thead><tbody><tr><td>Hydrogen</td><td><b>H</b></td><td><i>Lightest</i> gas</td></tr><tr><td>Water</td><td>H<sub>2</sub>O</td><td>Covers ~71% of Earth \u{1F30A}</td></tr><tr><td>Carbon-14</td><td><sup>14</sup>C</td><td>Used in <code>dating</code>; see <a href='https://example.com/'>docs</a></td></tr><tr><td>Caffeine</td><td>C<sub>8</sub>H<sub>10</sub>N<sub>4</sub>O<sub>2</sub></td><td>\u{2615} keeps you awake</td></tr><tr><td>Specials</td><td>a &amp; b &lt; c</td><td><s>struck</s> / <b>bold</b> / <i>em</i></td></tr></tbody></table>"
        }
        ...
        Html{
            width: Fill height: Fit
            body: "<table><thead><tr><th align='left'>Task</th><th align='center'>Status</th><th style='text-align: right'>Due</th></tr></thead><tbody><tr><td align='left'>Ship feature <b>X</b></td><td align='center'><code>WIP</code></td><td style='text-align: right'><b>Fri</b></td></tr><tr><td align='left'>Review <a href='https://example.com'>PR #42</a></td><td align='center'><i>Pending</i></td><td style='text-align: right'>Mon</td></tr><tr><td align='left'>Fix <s>critical</s> bug</td><td align='center'>Done \u{2705}</td><td style='text-align: right'>Yesterday</td></tr><tr><td align='left'>Write spec for H<sub>2</sub>O sync</td><td align='center'>50%</td><td style='text-align: right'>2026-05-15</td></tr><tr><td align='left'>Ship Widgets<sup>TM</sup> release</td><td align='center'>Blocked</td><td style='text-align: right'>TBD</td></tr></tbody></table>"
        }
