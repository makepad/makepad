//! The adaptive view stories: the default desktop and mobile variants switching on window width, ported from the widget zoo.
...
script_mod! {
    ...
    mod.stories.AdaptiveViewOverview = StoryPage{
...
pub const STORIES: &[Story] = &[Story {
    key: "navigation/adaptiveview/overview",
    category: "Navigation",
    component: "AdaptiveView",
    also: &[],
    name: "Overview",
    dsl: "AdaptiveViewOverview",
    added: "2026-02-26",
    tags: &["ported"],
