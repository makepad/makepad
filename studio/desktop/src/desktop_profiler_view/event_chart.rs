...
pub(crate) const DEFAULT_PROFILE_WINDOW_SECONDS: f64 = 0.5;
pub(crate) const MIN_PROFILE_WINDOW_SECONDS: f64 = 0.000_01;
pub(crate) const PROFILE_ROW_Y_STEP: f64 = 25.0;
pub(crate) const PROFILE_GRAPH_START_Y: f64 = PROFILE_ROW_Y_STEP * 3.0 + 24.0;
pub(crate) const PROFILE_GRAPH_LANE_HEIGHT: f64 = 56.0;
pub(crate) const PROFILE_GRAPH_LANE_GAP: f64 = 10.0;
pub(crate) const PROFILE_FRAMETIME_GRAPH_OFFSET_Y: f64 = PROFILE_GRAPH_START_Y;
pub(crate) const PROFILE_COUNTS_GRAPH_OFFSET_Y: f64 =
...
pub struct DesktopProfilerEventChart {
    #[uid]
    uid: WidgetUid,
    #[walk]
    walk: Walk,
...
impl DesktopProfilerEventChart {
    ...
    pub(crate) fn set_follow_live(&mut self, cx: &mut Cx, follow_live: bool) {
    ...
    pub(crate) fn reset_for_new_session(&mut self, cx: &mut Cx) {
        self.time_drag = None;
