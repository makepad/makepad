...
impl PositionSet {
    ...
    /// 
    /// ```
    /// use makepad_live_tokenizer::{position_set, Position, PositionSet};
    /// 
    ...
    /// 
    /// ```
    /// use makepad_live_tokenizer::{position_set, Position, Size};
    /// 
    /// let mut builder = position_set::Builder::new();
...
impl Builder {
    ...
    /// 
    /// ```
    /// use makepad_live_tokenizer::position_set::Builder;
    /// 
