...
live_design! {
    ...
    pub THEME_COLOR_SLIDER_BIG_HANDLE_TOP = #8
    pub THEME_COLOR_SLIDER_BIG_HANDLE_TOP_HOVER = #A
    pub THEME_COLOR_SLIDER_BIG_HANDLE_BOTTOM = #282828
    pub THEME_COLOR_SLIDER_BIG_HANDLE_BOTTOM_HOVER = #3
