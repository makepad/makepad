...
script_mod! {
    ...
    // The control surfaces keep their own edge: a clear profile vanishes over
    // a busy ground at this size, and a control that cannot be found is not
    // one. The panel family above takes the clearer material.
