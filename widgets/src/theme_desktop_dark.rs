...
live_design! {
    ...
    pub THEME_COLOR_TEXT_DARK = (THEME_COLOR_D_4)
    ...
    pub THEME_COLOR_SLIDER_HANDLE = (THEME_COLOR_U_3)
    pub THEME_COLOR_SLIDER_HANDLE_HOVER = (THEME_COLOR_U_4)
    pub THEME_COLOR_SLIDER_HANDLE_ACTIVE = (THEME_COLOR_WHITE)
