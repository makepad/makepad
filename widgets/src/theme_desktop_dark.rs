...
live_design! {
    ...
    THEME_COLOR_CONTRAST = 1.5 // HIGHER VALUE = HIGHER CONTRAST, RECOMMENDED VALUES: 0.5 - 2.5
    
    // COLOR PALETTE
    THEME_COLOR_WHITE = #FFFFFFFF
    THEME_COLOR_U_8 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.2, COLOR_CONTRAST)))
    THEME_COLOR_U_6 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.35, COLOR_CONTRAST)))
    THEME_COLOR_U_5 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.5, COLOR_CONTRAST)))
    THEME_COLOR_U_4 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.6, COLOR_CONTRAST)))
    THEME_COLOR_U_3 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.75, COLOR_CONTRAST)))
    THEME_COLOR_U_2 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.85, COLOR_CONTRAST)))
    THEME_COLOR_U_1 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.9, COLOR_CONTRAST)))
    THEME_COLOR_U_04 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.95, COLOR_CONTRAST)))

    THEME_COLOR_D_04 = (mix(#000000FF, #00000000, pow(0.9, COLOR_CONTRAST)))
    THEME_COLOR_D_075 = (mix(#000000FF, #00000000, pow(0.85, COLOR_CONTRAST)))
    THEME_COLOR_D_1 = (mix(#000000FF, #00000000, pow(0.8, COLOR_CONTRAST)))
    THEME_COLOR_D_2 = (mix(#000000FF, #00000000, pow(0.75, COLOR_CONTRAST)))
    THEME_COLOR_D_3 = (mix(#000000FF, #00000000, pow(0.6, COLOR_CONTRAST)))
    THEME_COLOR_D_4 = (mix(#000000FF, #00000000, pow(0.4, COLOR_CONTRAST)))
    THEME_COLOR_D_5 = (mix(#000000FF, #00000000, pow(0.35, COLOR_CONTRAST)))
    THEME_COLOR_BLACK = #000000FF

    // BASICS
    THEME_COLOR_MAKEPAD = #FF5C39FF

    THEME_COLOR_BG_APP = (mix(#000000FF, #8, pow(0.5, COLOR_CONTRAST)))
    // THEME_COLOR_BG_APP = #x3A
