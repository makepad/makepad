...
live_design! {
    ...
    // COLOR PALETTE
    THEME_COLOR_CONTRAST = 1. // HIGHER VALUE = HIGHER CONTRAST, RECOMMENDED VALUES: 0.5 - 2.5

    THEME_COLOR_WHITE = #FFFFFFFF
    THEME_COLOR_U_6 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.35, THEME_COLOR_CONTRAST)))
    THEME_COLOR_U_5 = (mix(#FFFFFFFF, #FFFFFF00, pow(0.6, THEME_COLOR_CONTRAST)))
    ...
    THEME_COLOR_DRAG_QUAD = (THEME_COLOR_U_6)
    ...
    THEME_COLOR_TEXT_PLACEHOLDER = (THEME_COLOR_U_5)
...
//     }
    ...
    RadioButton = <RadioButtonBase> {
        ...
        draw_radio: {
            uniform size: 7.0;
            // uniform color_active: (THEME_COLOR_U_3)
