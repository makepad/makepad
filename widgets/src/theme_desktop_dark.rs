...
live_design! {
    ...
    pub THEME_COLOR_BEVEL_HOVER = (THEME_COLOR_SHADOW_FOCUS)
    ...
    pub THEME_COLOR_BEVEL_INSET_2_HOVER = (THEME_COLOR_SHADOW_FOCUS)
    ...
    pub THEME_COLOR_INSET_DRAG = (THEME_COLOR_INSET_HOVER)
    ...
    pub THEME_COLOR_INSET_1_FOCUS = (THEME_COLOR_D_3)
