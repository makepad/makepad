...
live_design! {
    ...
    pub THEME_COLOR_SHADOW_FLAT_FOCUS = (THEME_COLOR_U_2)
    ...
    pub THEME_COLOR_BEVEL_HOVER = (THEME_COLOR_SHADOW_FLAT_FOCUS)
    pub THEME_COLOR_BEVEL_FOCUS = (THEME_COLOR_SHADOW_FLAT_FOCUS)
    pub THEME_COLOR_BEVEL_ACTIVE = (THEME_COLOR_BEVEL)
    pub THEME_COLOR_BEVEL_EMPTY = (THEME_COLOR_BEVEL)
    pub THEME_COLOR_BEVEL_DOWN = (THEME_COLOR_SHADOW_FLAT_FOCUS)
    ...
    pub THEME_COLOR_INSET_FOCUS = (THEME_COLOR_D_1)
