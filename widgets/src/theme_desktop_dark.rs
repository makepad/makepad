...
live_design! {
    ...
    // WIDGET COLORS
    pub THEME_COLOR_CTRL = (THEME_COLOR_U_1)
    pub THEME_COLOR_CTRL_PRESSED = (THEME_COLOR_D_1)
    pub THEME_COLOR_CTRL_HOVER = (THEME_COLOR_U_2)
    pub THEME_COLOR_CTRL_ACTIVE = (THEME_COLOR_D_1)
    pub THEME_COLOR_CTRL_FOCUS = (THEME_COLOR_U_2)
    pub THEME_COLOR_CTRL_DRAG = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_AMOUNT_FOCUS = (THEME_COLOR_U_4)
    ...
    pub THEME_COLOR_SLIDER_NUB = (THEME_COLOR_U_3)
    pub THEME_COLOR_SLIDER_NUB_HOVER = (THEME_COLOR_U_4)
    ...
    pub THEME_COLOR_SLIDER_BIG_NUB = #6
    pub THEME_COLOR_SLIDER_BIG_NUB_HOVER = #8
    pub THEME_COLOR_SLIDER_BIG_NUB_FOCUS = #7
    pub THEME_COLOR_SLIDER_BIG_NUB_DRAG = #A
