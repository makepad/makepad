...
live_design! {
    ...
    pub THEME_COLOR_SLIDER_BIG_HANDLE = #6
    pub THEME_COLOR_SLIDER_HANDLE_HOVER = #8
    pub THEME_COLOR_SLIDER_HANDLE_FOCUS = #7
    pub THEME_COLOR_SLIDER_HANDLE_DRAG = #A
    pub THEME_COLOR_SLIDER_HANDLE_TOP = #8
    pub THEME_COLOR_SLIDER_HANDLE_TOP_HOVER = #A
    pub THEME_COLOR_SLIDER_HANDLE_BOTTOM = #282828
    pub THEME_COLOR_SLIDER_HANDLE_BOTTOM_HOVER = #3
