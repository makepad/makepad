...
live_design! {
    ...
    pub THEME_COLOR_U_3 = (mix(THEME_COLOR_W, THEME_COLOR_W_H, pow(0.8, THEME_COLOR_CONTRAST)))
    ...
    pub THEME_COLOR_D_05 = (mix(THEME_COLOR_B, THEME_COLOR_B_H, pow(0.925, THEME_COLOR_CONTRAST)))
    pub THEME_COLOR_D_075 = (mix(THEME_COLOR_B, THEME_COLOR_B_H, pow(0.9, THEME_COLOR_CONTRAST)))
    pub THEME_COLOR_D_1 = (mix(THEME_COLOR_B, THEME_COLOR_B_H, pow(0.875, THEME_COLOR_CONTRAST)))
    ...
    pub THEME_COLOR_BG_APP = (mix(
        ...
        pow(0.15, THEME_COLOR_CONTRAST)))
    pub THEME_COLOR_FG_APP = (mix(
        (THEME_COLOR_W * mix(#ffffff, THEME_COLOR_TINT, THEME_COLOR_TINT_AMOUNT)),
        (THEME_COLOR_B * mix(#ffffff, THEME_COLOR_TINT, THEME_COLOR_TINT_AMOUNT)),
        pow(0.175, THEME_COLOR_CONTRAST))
    )
    ...
    pub THEME_COLOR_OPAQUE_D_05 = (mix(THEME_COLOR_FG_APP, #0, 0.05))
    ...
    pub THEME_COLOR_SHADOW = (THEME_COLOR_D_1)
    pub THEME_COLOR_SHADOW_FOCUS = (THEME_COLOR_D_2)
    pub THEME_COLOR_SHADOW_DISABLED = (THEME_COLOR_D_05)
    pub THEME_COLOR_SHADOW_FLAT = (THEME_COLOR_D_1)
    pub THEME_COLOR_SHADOW_FLAT_DISABLED = (THEME_COLOR_OPAQUE_D_2)
    pub THEME_COLOR_LIGHT = (THEME_COLOR_U_4)
    pub THEME_COLOR_LIGHT_HOVER = (THEME_COLOR_U_5)
    pub THEME_COLOR_LIGHT_FOCUS = (THEME_COLOR_U_5)
    pub THEME_COLOR_LIGHT_DISABLED = (THEME_COLOR_D_05)

    pub THEME_COLOR_FLAT_FOCUS = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_HIGHLIGHT = (THEME_COLOR_D_1)
    pub THEME_COLOR_TEXT_CURSOR = (THEME_COLOR_WHITE)
    pub THEME_COLOR_BG_HIGHLIGHT_INLINE = (THEME_COLOR_D_1)

    pub THEME_COLOR_TEXT = (THEME_COLOR_D_4)
    pub THEME_COLOR_TEXT_VAL = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_TEXT_DISABLED = (THEME_COLOR_D_1)
    pub THEME_COLOR_TEXT_PLACEHOLDER = (THEME_COLOR_D_3)
    pub THEME_COLOR_TEXT_PLACEHOLDER_HOVER = (THEME_COLOR_D_3)
    pub THEME_COLOR_TEXT_META = (THEME_COLOR_D_3)

    pub THEME_COLOR_LABEL_INNER = (THEME_COLOR_D_4)
    pub THEME_COLOR_LABEL_INNER_DOWN = (THEME_COLOR_D_5)
    ...
    pub THEME_COLOR_LABEL_INNER_INACTIVE = (THEME_COLOR_D_3)
    pub THEME_COLOR_LABEL_INNER_DISABLED = (THEME_COLOR_D_2)

    pub THEME_COLOR_LABEL_OUTER = (THEME_COLOR_D_5)
    pub THEME_COLOR_LABEL_OUTER_OFF = (THEME_COLOR_D_3)
    ...
    pub THEME_COLOR_LABEL_OUTER_DISABLED = (THEME_COLOR_D_3)

    pub THEME_COLOR_ICON = (THEME_COLOR_U_2)
    pub THEME_COLOR_ICON_ACTIVE = (THEME_COLOR_D_4)
    pub THEME_COLOR_ICON_DISABLED = (THEME_COLOR_U_4)
    ...
    pub THEME_COLOR_INSET = (THEME_COLOR_D_075)
    ...
    pub THEME_COLOR_INSET_DISABLED = (THEME_COLOR_U_1)
    pub THEME_COLOR_INSET_EMPTY = (THEME_COLOR_INSET)

    pub THEME_COLOR_INSET_1 = (THEME_COLOR_D_1)
    pub THEME_COLOR_INSET_1_HOVER = (THEME_COLOR_D_2)
    ...
    pub THEME_COLOR_INSET_1_DRAG = (THEME_COLOR_INSET_1_HOVER)
    pub THEME_COLOR_INSET_1_EMPTY = (THEME_COLOR_U_HIDDEN)
    pub THEME_COLOR_INSET_1_DISABLED = (THEME_COLOR_INSET_1)

    pub THEME_COLOR_INSET_2 = (THEME_COLOR_D_05)
    pub THEME_COLOR_INSET_2_HOVER = (THEME_COLOR_D_1)
    ...
    pub THEME_COLOR_INSET_2_DRAG = (THEME_COLOR_INSET_2_HOVER)
    pub THEME_COLOR_INSET_2_DISABLED = (THEME_COLOR_U_1)
    pub THEME_COLOR_INSET_2_EMPTY = (THEME_COLOR_INSET_2)

    // WIDGET COLORS
    pub THEME_COLOR_OUTSET = (THEME_COLOR_U_3)
    pub THEME_COLOR_OUTSET_DOWN = (THEME_COLOR_U_1)
    pub THEME_COLOR_OUTSET_HOVER = (THEME_COLOR_U_4)
    pub THEME_COLOR_OUTSET_ACTIVE = (THEME_COLOR_U_5)
    ...
    pub THEME_COLOR_OUTSET_1 = (THEME_COLOR_U_4)
    ...
    pub THEME_COLOR_OUTSET_1_ACTIVE = (THEME_COLOR_U_6)
    pub THEME_COLOR_OUTSET_1_FOCUS = (THEME_COLOR_OUTSET_1)
    pub THEME_COLOR_OUTSET_1_DISABLED = (THEME_COLOR_U_1)

    pub THEME_COLOR_OUTSET_2 = (THEME_COLOR_U_HIDDEN)
    pub THEME_COLOR_OUTSET_2_DOWN = (THEME_COLOR_D_HIDDEN)
    pub THEME_COLOR_OUTSET_2_HOVER = (THEME_COLOR_U_2)
    pub THEME_COLOR_OUTSET_2_DRAG = (THEME_COLOR_OUTSET_2_DOWN)
    pub THEME_COLOR_OUTSET_2_ACTIVE = (THEME_COLOR_U_4)
    pub THEME_COLOR_OUTSET_2_FOCUS = (THEME_COLOR_OUTSET_2_HOVER)
    pub THEME_COLOR_OUTSET_2_DISABLED = (THEME_COLOR_U_HIDDEN)

    pub THEME_COLOR_MARK = (THEME_COLOR_D_4)
    ...
    pub THEME_COLOR_MARK_DOWN = (THEME_COLOR_D_3)
    pub THEME_COLOR_MARK_DISABLED = (THEME_COLOR_D_2)

    pub THEME_COLOR_SELECTION = (THEME_COLOR_U_HIDDEN)
    pub THEME_COLOR_SELECTION_HOVER = (THEME_COLOR_D_2)
    pub THEME_COLOR_SELECTION_DOWN = (THEME_COLOR_D_2)
    pub THEME_COLOR_SELECTION_FOCUS = (THEME_COLOR_D_2)
    pub THEME_COLOR_SELECTION_EMPTY = (THEME_COLOR_U_HIDDEN)
    pub THEME_COLOR_SELECTION_DISABLED = (THEME_COLOR_U_HIDDEN)

    // Progress bars, slider amounts etc.
    pub THEME_COLOR_VAL = (THEME_COLOR_OPAQUE_D_2)
    pub THEME_COLOR_VAL_HOVER = (THEME_COLOR_OPAQUE_D_3)
    ...
    pub THEME_COLOR_VAL_1 = (THEME_COLOR_OPAQUE_D_2)
    pub THEME_COLOR_VAL_1_HOVER = (THEME_COLOR_OPAQUE_D_3)
