//! A scrollbar whose track says what is in the part of the content that is
//! off screen.
//!
//! A scroll view is very quiet about what it is not showing. The bar says
//! roughly how far down the handle is and nothing about what is down there.
//! This one answers that; `scroll_fade` answers the same question at the edge
//! of the box instead of along its track.
//!
//! # AnnotatedScrollBar
//!
