...
// The list driven directly; the cases driven through the log list, a portal
// list of lines, are in the rich text family beside it.
#[cfg(test)]
mod tests {
