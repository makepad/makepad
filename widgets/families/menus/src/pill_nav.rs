...
use crate::{
    ...
    family_api::{for_each_element, obj_bool, obj_field, obj_string, orphan_sweep_locks, release_orphaned_sweep_locks},
    overlay_place::{claim_escape, place_overlay, PlaceRequest, Placed, Side},
...
mod tests {
    ...
    fn a_bar_dropped_open_leaves_its_lock_for_the_next_event() {
        ...
        crate::family_api::release_orphaned_sweep_locks(&mut cx);
...
/// A pill nav's open panel holds the pointer through the overlay lock; the
/// page rebuilt under it gives it back (moved here from overlay_place.rs's
/// lock tests with the pill nav).
#[cfg(test)]
mod lock_tests {
    use crate::family_api::release_orphaned_sweep_locks;
    use crate::pill_nav::{PillNavItem, PillNavLink, PillNavWidgetRefExt};
    use crate::{makepad_draw::cx_draw::CxDraw, makepad_draw::*, widget::*};
