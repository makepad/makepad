...
-s'../wabt/bin/wasm-strip ./webgl/target/wasm32-unknown-unknown/release/makepad_webgl.webassembly' \
-s'ls -al ./webgl/target/wasm32-unknown-unknown/release/|grep makepad_webgl.webassembly' \
-s'echo "Zipped size:";gzip -9 < ./webgl/target/wasm32-unknown-unknown/release/makepad_webgl.webassembly|wc -c' \
-s'twiggy top -n 20 ./webgl/target/wasm32-unknown-unknown/release/makepad_webgl.webassembly'
