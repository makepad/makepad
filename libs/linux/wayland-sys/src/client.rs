...
unsafe extern "C" {
    // display creation and destruction
    pub fn wl_display_connect_to_fd(_: c_int) -> *mut wl_display;
    pub fn wl_display_connect(_: *const c_char) -> *mut wl_display;
    pub fn wl_display_disconnect(_: *mut wl_display);
    pub fn wl_display_get_fd(_: *mut wl_display) -> c_int;
    // display events handling
    pub fn wl_display_roundtrip(_: *mut wl_display) -> c_int;
    pub fn wl_display_read_events(_: *mut wl_display) -> c_int;
    pub fn wl_display_prepare_read(_: *mut wl_display) -> c_int;
    pub fn wl_display_cancel_read(_: *mut wl_display);
    pub fn wl_display_dispatch(_: *mut wl_display) -> c_int;
    pub fn wl_display_dispatch_pending(_: *mut wl_display) -> c_int;
    // error handling
    pub fn wl_display_get_error(_: *mut wl_display) -> c_int;
    pub fn wl_display_get_protocol_error(
        _: *mut wl_display,
        _: *mut *const wl_interface,
        _: *mut u32,
    ) -> u32;
    // requests handling
    pub fn wl_display_flush(_: *mut wl_display) -> c_int;

    // event queues
    pub fn wl_event_queue_destroy(_: *mut wl_event_queue);
    pub fn wl_display_create_queue(_: *mut wl_display) -> *mut wl_event_queue;
    pub fn wl_display_roundtrip_queue(_: *mut wl_display, _: *mut wl_event_queue) -> c_int;
    pub fn wl_display_prepare_read_queue(_: *mut wl_display, _: *mut wl_event_queue) -> c_int;
    pub fn wl_display_dispatch_queue(_: *mut wl_display, _: *mut wl_event_queue) -> c_int;
    pub fn wl_display_dispatch_queue_pending(_: *mut wl_display, _: *mut wl_event_queue) -> c_int;

    // proxys
    pub fn wl_proxy_create(_: *mut wl_proxy, _: *const wl_interface) -> *mut wl_proxy;
    pub fn wl_proxy_destroy(_: *mut wl_proxy);
    pub fn wl_proxy_add_listener(
        _: *mut wl_proxy,
        _: *mut extern "C" fn(),
        _: *mut c_void,
    ) -> c_int;
    pub fn wl_proxy_get_listener(_: *mut wl_proxy) -> *const c_void;
    ...
    pub fn wl_proxy_marshal_array(_: *mut wl_proxy, _: u32, _: *mut wl_argument);
    pub fn wl_proxy_set_user_data(_: *mut wl_proxy, _: *mut c_void);
    pub fn wl_proxy_get_user_data(_: *mut wl_proxy) -> *mut c_void;
    pub fn wl_proxy_get_id(_: *mut wl_proxy) -> u32;
    pub fn wl_proxy_get_class(_: *mut wl_proxy) -> *const c_char;
    pub fn wl_proxy_set_queue(_: *mut wl_proxy, _: *mut wl_event_queue);
    pub fn wl_proxy_get_version(_: *mut wl_proxy) -> u32;
    pub fn wl_proxy_create_wrapper(_: *mut wl_proxy) -> *mut wl_proxy;
    pub fn wl_proxy_wrapper_destroy(_: *mut wl_proxy);

    // log
    pub fn wl_log_set_handler_client(_: wl_log_func_t);

    // lists
    pub fn wl_list_init(_: *mut wl_list);
    pub fn wl_list_insert(_: *mut wl_list, _: *mut wl_list);
    pub fn wl_list_remove(_: *mut wl_list);
    pub fn wl_list_length(_: *const wl_list) -> c_int;
    pub fn wl_list_empty(_: *const wl_list) -> c_int;
    pub fn wl_list_insert_list(_: *mut wl_list, _: *mut wl_list);

    // arrays
    pub fn wl_array_init(_: *mut wl_array);
    pub fn wl_array_release(_: *mut wl_array);
    pub fn wl_array_add(_: *mut wl_array, _: usize);
    pub fn wl_array_copy(_: *mut wl_array, _: *mut wl_array);
    ...
    pub fn wl_proxy_marshal(_: *mut wl_proxy, _: u32, ...);
}
