...
fn main() {
    ...
    let params = makepad_voice2::WhisperParams::default();
    eprintln!(
    ...
    match makepad_voice2::apple_speech::ensure_model(&params.language) {
    ...
    let segments = makepad_voice2::apple_speech::transcribe(&samples, &params);
