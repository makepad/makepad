...
const METAL_PATH: &str = "libs/voice2/src/metal/ggml/ggml-metal.metal";
const METAL_BACKUP_PATH: &str = "libs/voice2/src/metal/ggml/ggml-metal.metal.bak";
const COMMON_H_PATH: &str = "libs/voice2/src/metal/ggml/ggml-common.h";
const METAL_IMPL_H_PATH: &str = "libs/voice2/src/metal/ggml/ggml-metal-impl.h";
