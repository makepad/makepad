    ...
    quote! {
      ...
      impl napi_ohos::bindgen_prelude::ValidateNapiValue for #name {
        unsafe fn validate(
          ...
          napi_ohos::bindgen_prelude::assert_type_of!(env, napi_val, napi_ohos::bindgen_prelude::ValueType::Number)?;
          Ok(std::ptr::null_mut())
        }
      }
      ...
      impl napi_ohos::bindgen_prelude::FromNapiValue for #name {
        unsafe fn from_napi_value(
          ...
          let val = napi_ohos::bindgen_prelude::FromNapiValue::from_napi_value(env, napi_val).map_err(|e| {
