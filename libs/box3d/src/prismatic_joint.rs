...
pub fn solve_prismatic_joint(base: &mut JointSim, states: &StateAccess, context: &StepContext, use_bias: bool) {
    ...
    if joint.enable_spring && !fixed_rotation {
        ...
        let delta_impulse = -mass_scale * axial_mass * (cdot + bias) - impulse_scale * joint.spring_impulse;
    ...
    if joint.enable_limit && !fixed_rotation {
        ...
        // Lower limit
        {
            ...
            if c < speculative_distance {
                ...
                let mut delta_impulse = -mass_scale * axial_mass * (cdot + bias) - impulse_scale * old_impulse;
        ...
        // Upper limit
        {
            ...
            if c < speculative_distance {
                ...
                let delta_impulse = -mass_scale * axial_mass * (cdot + bias) - impulse_scale * old_impulse;
