...
pub use runtime::{
    ...
    build_attention_decode_graph, build_delta_net_recurrent_decode_graph, build_logits_probe_graph,
    build_moe_ffn_graph, compile_attention_block_metal, compile_attention_decode_metal,
    compile_delta_net_recurrent_decode_metal, compile_hybrid_decode_metal,
    compile_hybrid_decode_metal_with_shared_state, compile_hybrid_prompt_processing_metal,
    compile_hybrid_prompt_processing_metal_with_shared_state,
    compile_hybrid_token_generation_metal, compile_hybrid_token_generation_metal_with_shared_state,
    compile_logits_probe_metal, compile_moe_ffn_metal, create_metal_context_buffer,
    ...
    prepare_logits_probe_graph, prepare_moe_ffn_graph, AttentionBlockGraph, AttentionBlockRun,
    AttentionBlockSpec, AttentionDecodeGraph, AttentionDecodeSpec, AttentionKvCacheSpec,
    AttentionQueryLayout, AttentionRopeSpec, CompiledAttentionBlockMetal,
    CompiledAttentionDecodeMetal, CompiledDeltaNetRecurrentDecodeMetal, CompiledHybridDecodeMetal,
    CompiledLogitsProbeMetal, CompiledMoeFfnMetal, DeltaNetRecurrentBlockSpec,
    DeltaNetRecurrentDecodeGraph, DeltaNetRecurrentDecodeSpec, DeltaNetRecurrentStateSpec,
    DenseGatedFfnSpec, ExpertGatingFunc, GraphBatch, HybridAttentionCacheIds,
    HybridAttentionCacheView, HybridCacheLayout, HybridCacheShape, HybridCacheSpec,
    HybridCacheTemplate, HybridCacheTypes, HybridDecodeGraph, HybridDecodeOutputConfig,
    HybridDecodeRun, HybridDecodeSpec, HybridLayerSpec, HybridRecurrentCacheIds,
