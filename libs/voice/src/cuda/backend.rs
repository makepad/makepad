...
pub(crate) fn try_matmul_nt_f32_bytes(
    ...
    matmul_nt_bytes(a, bt_bytes, crate::quant::GGML_TYPE_F32, m, k, n, None)
}
...
pub(crate) fn try_matmul_nt_f16_bytes(
    ...
    matmul_nt_bytes(a, bt_f16_bytes, crate::quant::GGML_TYPE_F16, m, k, n, None)
}
...
mod tests {
    ...
    fn dequant_f32_and_f16_roundtrip() {
        use crate::quant::{f32_to_f16, GGML_TYPE_F16, GGML_TYPE_F32};
    ...
    fn dequant_matches_raw_tensor_to_f32() {
        use crate::quant::{quantize_f32_to_q8_0, GGML_TYPE_Q8_0};
