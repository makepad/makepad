...
pub struct AlignedSegment {
    ...
    pub end_ms: i64,
    pub text: String,
    pub words: Vec<crate::align::WordSpan>,
...
impl WhisperState {
    ...
    fn transcribe_impl(
        ...
        let heads = align.then(|| crate::align::AlignmentHeads::for_model(&model.hparams));
        ...
        while seek < mel_end {
            ...
            let words_for = |tokens: &[(usize, &str)]| -> Vec<crate::align::WordSpan> {
                match &alignment {
                    Some(alignment) => {
                        crate::align::words_from_tokens(tokens, alignment, chunk_start_ms)
                    }
                    None => Vec::new(),
                }
            };
    ...
    pub fn force_align(
        ...
        tokens: &[i32],
        language: &str,
    ) -> Option<Vec<crate::align::WordSpan>> {
        ...
        let mut capture = crate::align::AlignCapture::new(
            &crate::align::AlignmentHeads::for_model(&model.hparams),
            model.hparams.n_text_layer as usize,
            model.hparams.n_text_head as usize,
            n_ctx,
        );
        ...
        let alignment = crate::align::align_rows(
            &capture,
            n_prompt - 1,
        ...
        let texts: Vec<(usize, &str)> = tokens
            ...
            .collect();
        Some(crate::align::words_from_tokens(&texts, &alignment, 0))
    }
}
