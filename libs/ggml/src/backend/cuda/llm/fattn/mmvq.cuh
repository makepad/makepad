#pragma once
// Copied from llama.cpp ggml/src/ggml-cuda/mmvq.cu (kernel + launch helpers).
// Host ggml_backend cases trimmed; inner mul_mat_vec_q is compile-identical.
#include "common.cuh"
#include "vecdotq.cuh"
