...
impl ScriptThread {
    ...
    pub(crate) fn handle_assign(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(id) = id.as_id(){
            ...
            let value = script_err_immutable!(self.trap, "assign target is not an identifier, got {:?}", id.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_add(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(id) = id.as_id(){
            ...
            let value = script_err_immutable!(self.trap, "+= target is not an identifier, got {:?}", id.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_field(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_wrong_value!(self.trap, "cannot assign field {:?} on {:?} (not an object)", field, object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_field_add(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_immutable!(self.trap, "cannot += field {:?} on {:?} (not an object)", field, object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_field_ifnil(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_wrong_value!(self.trap, "cannot ?= field {:?} on {:?} (not an object)", field, object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_index(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_wrong_value!(self.trap, "cannot assign index {:?} on {:?} (not an object/array)", index, object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_index_add(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_immutable!(self.trap, "cannot += index {:?} on {:?} (not an object/array)", index, object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_index_ifnil(&mut self, heap: &mut ScriptHeap) {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_wrong_value!(self.trap, "cannot ?= index {:?} on {:?} (not an object/array)", index, object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    pub(crate) fn handle_assign_me(&mut self, heap: &mut ScriptHeap) {
        ...
        if self.call_has_me(){
            ...
            match me{
                ...
                ScriptMe::Array(_arr)=>{
                    script_err_not_allowed!(self.trap, "named assign {:?} not allowed in array literal context", field);
                }
            }
        }
        self.trap.goto_next();
    ...
    pub(crate) fn handle_assign_me_before_after(&mut self, heap: &mut ScriptHeap, opcode: Opcode) {
        ...
        let value = match self.mes.last().unwrap(){
            ScriptMe::Call{..} | ScriptMe::Pod{..}=>{
                script_err_not_allowed!(self.trap, "before/after {:?} not allowed in function call arguments", field)
            }
            ScriptMe::Object(obj)=>{
                heap.vec_insert_value_at(*obj, field, value, opcode == Opcode::ASSIGN_ME_BEFORE, self.trap.pass())
            }
            ScriptMe::Array(_arr)=>{
                script_err_not_allowed!(self.trap, "before/after {:?} not allowed in array literal context", field)
            }
        };
        self.push_stack_unchecked(value);
        self.trap.goto_next();
    ...
    pub(crate) fn handle_assign_me_begin(&mut self, heap: &mut ScriptHeap) {
        ...
        let value = match self.mes.last().unwrap(){
            ScriptMe::Call{..} | ScriptMe::Pod{..}=>{
                script_err_not_allowed!(self.trap, "begin {:?} not allowed in function call arguments", field)
            }
            ScriptMe::Object(obj)=>{
                heap.vec_insert_value_begin(*obj, field, value, self.trap.pass())
            }
            ScriptMe::Array(_arr)=>{
                script_err_not_allowed!(self.trap, "begin {:?} not allowed in array literal context", field)
            }
        };
        self.push_stack_unchecked(value);
        self.trap.goto_next();
    ...
    where F: FnOnce(f64, f64) -> f64
    {
        ...
        if let Some(id) = id.as_id(){
            ...
            let value = script_err_immutable!(self.trap, "compound assignment target is not an identifier, got {:?}", id.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    where F: FnOnce(u64, u64) -> u64
    {
        ...
        if let Some(id) = id.as_id(){
            ...
            let value = script_err_immutable!(self.trap, "bitwise compound assignment target is not an identifier, got {:?}", id.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    where F: FnOnce(f64, f64) -> f64
    {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_immutable!(self.trap, "field compound assignment on {:?} (not an object)", object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    where F: FnOnce(u64, u64) -> u64
    {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_immutable!(self.trap, "field bitwise compound assignment on {:?} (not an object)", object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    where F: FnOnce(f64, f64) -> f64
    {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_immutable!(self.trap, "index compound assignment on {:?} (not an object/array)", object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
    ...
    where F: FnOnce(u64, u64) -> u64
    {
        ...
        if let Some(obj) = object.as_object(){
            ...
            let value = script_err_immutable!(self.trap, "index bitwise compound assignment on {:?} (not an object/array)", object.value_type());
            self.push_stack_unchecked(value);
        }
        self.trap.goto_next();
    }
