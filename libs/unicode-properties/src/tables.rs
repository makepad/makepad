...
pub mod general_category {
    ...
    const GENERAL_CATEGORY: &[(char, char, GeneralCategory)] = &[
        ...
        ('\u{294}', '\u{295}', GeneralCategory::OtherLetter), ('\u{296}', '\u{2af}',
        ...
        GeneralCategory::ModifierSymbol), ('\u{889}', '\u{88f}', GeneralCategory::OtherLetter),
        ...
        GeneralCategory::OtherLetter), ('\u{c5c}', '\u{c5d}', GeneralCategory::OtherLetter),
        ...
        ('\u{cd5}', '\u{cd6}', GeneralCategory::SpacingMark), ('\u{cdc}', '\u{cde}',
        ...
        ('\u{1abf}', '\u{1add}', GeneralCategory::NonspacingMark), ('\u{1ae0}', '\u{1aeb}',
        GeneralCategory::NonspacingMark), ('\u{1b00}', '\u{1b03}', GeneralCategory::NonspacingMark),
        ('\u{1b04}', '\u{1b04}', GeneralCategory::SpacingMark), ('\u{1b05}', '\u{1b33}',
        GeneralCategory::OtherLetter), ('\u{1b34}', '\u{1b34}', GeneralCategory::NonspacingMark),
        ('\u{1b35}', '\u{1b35}', GeneralCategory::SpacingMark), ('\u{1b36}', '\u{1b3a}',
        GeneralCategory::NonspacingMark), ('\u{1b3b}', '\u{1b3b}', GeneralCategory::SpacingMark),
        ('\u{1b3c}', '\u{1b3c}', GeneralCategory::NonspacingMark), ('\u{1b3d}', '\u{1b41}',
        GeneralCategory::SpacingMark), ('\u{1b42}', '\u{1b42}', GeneralCategory::NonspacingMark),
        ('\u{1b43}', '\u{1b44}', GeneralCategory::SpacingMark), ('\u{1b45}', '\u{1b4c}',
        GeneralCategory::OtherLetter), ('\u{1b4e}', '\u{1b4f}', GeneralCategory::OtherPunctuation),
        ('\u{1b50}', '\u{1b59}', GeneralCategory::DecimalNumber), ('\u{1b5a}', '\u{1b60}',
        ...
        GeneralCategory::ModifierLetter), ('\u{20a0}', '\u{20c1}', GeneralCategory::CurrencySymbol),
        ...
        GeneralCategory::OtherSymbol), ('\u{2b76}', '\u{2bff}', GeneralCategory::OtherSymbol),
        ('\u{2c00}', '\u{2c2f}', GeneralCategory::UppercaseLetter), ('\u{2c30}', '\u{2c5f}',
        ...
        GeneralCategory::LowercaseLetter), ('\u{a7ce}', '\u{a7ce}',
        GeneralCategory::UppercaseLetter), ('\u{a7cf}', '\u{a7cf}',
        GeneralCategory::LowercaseLetter), ('\u{a7d0}', '\u{a7d0}',
        GeneralCategory::UppercaseLetter), ('\u{a7d1}', '\u{a7d1}',
        GeneralCategory::LowercaseLetter), ('\u{a7d2}', '\u{a7d2}',
        GeneralCategory::UppercaseLetter), ('\u{a7d3}', '\u{a7d3}',
        GeneralCategory::LowercaseLetter), ('\u{a7d4}', '\u{a7d4}',
        GeneralCategory::UppercaseLetter), ('\u{a7d5}', '\u{a7d5}',
        ...
        GeneralCategory::UppercaseLetter), ('\u{a7f1}', '\u{a7f4}',
        ...
        ('\u{fbc3}', '\u{fbd2}', GeneralCategory::OtherSymbol), ('\u{fbd3}', '\u{fd3d}',
        GeneralCategory::OtherLetter), ('\u{fd3e}', '\u{fd3e}', GeneralCategory::ClosePunctuation),
        ('\u{fd3f}', '\u{fd3f}', GeneralCategory::OpenPunctuation), ('\u{fd40}', '\u{fd4f}',
        GeneralCategory::OtherSymbol), ('\u{fd50}', '\u{fd8f}', GeneralCategory::OtherLetter),
        ('\u{fd90}', '\u{fd91}', GeneralCategory::OtherSymbol), ('\u{fd92}', '\u{fdc7}',
        GeneralCategory::OtherLetter), ('\u{fdc8}', '\u{fdcf}', GeneralCategory::OtherSymbol),
        ...
        GeneralCategory::OtherPunctuation), ('\u{10940}', '\u{10959}',
        GeneralCategory::OtherLetter), ('\u{10980}', '\u{109b7}', GeneralCategory::OtherLetter),
        ('\u{109bc}', '\u{109bd}', GeneralCategory::OtherNumber), ('\u{109be}', '\u{109bf}',
        GeneralCategory::OtherLetter), ('\u{109c0}', '\u{109cf}', GeneralCategory::OtherNumber),
        ('\u{109d2}', '\u{109ff}', GeneralCategory::OtherNumber), ('\u{10a00}', '\u{10a00}',
        GeneralCategory::OtherLetter), ('\u{10a01}', '\u{10a03}', GeneralCategory::NonspacingMark),
        ('\u{10a05}', '\u{10a06}', GeneralCategory::NonspacingMark), ('\u{10a0c}', '\u{10a0f}',
        ...
        ('\u{10ec5}', '\u{10ec5}', GeneralCategory::ModifierLetter), ('\u{10ec6}', '\u{10ec7}',
        GeneralCategory::OtherLetter), ('\u{10ed0}', '\u{10ed0}',
        GeneralCategory::OtherPunctuation), ('\u{10ed1}', '\u{10ed8}',
        GeneralCategory::OtherSymbol), ('\u{10efa}', '\u{10eff}', GeneralCategory::NonspacingMark),
        ('\u{10f00}', '\u{10f1c}', GeneralCategory::OtherLetter), ('\u{10f1d}', '\u{10f26}',
        GeneralCategory::OtherNumber), ('\u{10f27}', '\u{10f27}', GeneralCategory::OtherLetter),
        ('\u{10f30}', '\u{10f45}', GeneralCategory::OtherLetter), ('\u{10f46}', '\u{10f50}',
        GeneralCategory::NonspacingMark), ('\u{10f51}', '\u{10f54}', GeneralCategory::OtherNumber),
        ('\u{10f55}', '\u{10f59}', GeneralCategory::OtherPunctuation), ('\u{10f70}', '\u{10f81}',
        ...
        GeneralCategory::OtherPunctuation), ('\u{11b60}', '\u{11b60}',
        GeneralCategory::NonspacingMark), ('\u{11b61}', '\u{11b61}', GeneralCategory::SpacingMark),
        ('\u{11b62}', '\u{11b64}', GeneralCategory::NonspacingMark), ('\u{11b65}', '\u{11b65}',
        GeneralCategory::SpacingMark), ('\u{11b66}', '\u{11b66}', GeneralCategory::NonspacingMark),
        ('\u{11b67}', '\u{11b67}', GeneralCategory::SpacingMark), ('\u{11bc0}', '\u{11be0}',
        ...
        ('\u{11da0}', '\u{11da9}', GeneralCategory::DecimalNumber), ('\u{11db0}', '\u{11dd8}',
        GeneralCategory::OtherLetter), ('\u{11dd9}', '\u{11dd9}', GeneralCategory::ModifierLetter),
        ('\u{11dda}', '\u{11ddb}', GeneralCategory::OtherLetter), ('\u{11de0}', '\u{11de9}',
        GeneralCategory::DecimalNumber), ('\u{11ee0}', '\u{11ef2}', GeneralCategory::OtherLetter),
        ('\u{11ef3}', '\u{11ef4}', GeneralCategory::NonspacingMark), ('\u{11ef5}', '\u{11ef6}',
        GeneralCategory::SpacingMark), ('\u{11ef7}', '\u{11ef8}',
        ...
        ('\u{16e97}', '\u{16e9a}', GeneralCategory::OtherPunctuation), ('\u{16ea0}', '\u{16eb8}',
        GeneralCategory::UppercaseLetter), ('\u{16ebb}', '\u{16ed3}',
        GeneralCategory::LowercaseLetter), ('\u{16f00}', '\u{16f4a}', GeneralCategory::OtherLetter),
        ('\u{16f4f}', '\u{16f4f}', GeneralCategory::NonspacingMark), ('\u{16f50}', '\u{16f50}',
        GeneralCategory::OtherLetter), ('\u{16f51}', '\u{16f87}', GeneralCategory::SpacingMark),
        ('\u{16f8f}', '\u{16f92}', GeneralCategory::NonspacingMark), ('\u{16f93}', '\u{16f9f}',
        GeneralCategory::ModifierLetter), ('\u{16fe0}', '\u{16fe1}',
        ...
        ('\u{16ff2}', '\u{16ff3}', GeneralCategory::ModifierLetter), ('\u{16ff4}', '\u{16ff6}',
        GeneralCategory::LetterNumber), ('\u{17000}', '\u{18cd5}', GeneralCategory::OtherLetter),
        ('\u{18cff}', '\u{18d1e}', GeneralCategory::OtherLetter), ('\u{18d80}', '\u{18df2}',
        GeneralCategory::OtherLetter), ('\u{1aff0}', '\u{1aff3}', GeneralCategory::ModifierLetter),
        ('\u{1aff5}', '\u{1affb}', GeneralCategory::ModifierLetter), ('\u{1affd}', '\u{1affe}',
        ...
        GeneralCategory::DecimalNumber), ('\u{1ccfa}', '\u{1ccfc}', GeneralCategory::OtherSymbol),
        ('\u{1cd00}', '\u{1ceb3}', GeneralCategory::OtherSymbol), ('\u{1ceba}', '\u{1ced0}',
        GeneralCategory::OtherSymbol), ('\u{1cee0}', '\u{1ceef}', GeneralCategory::OtherSymbol),
        ('\u{1cef0}', '\u{1cef0}', GeneralCategory::MathSymbol), ('\u{1cf00}', '\u{1cf2d}',
        GeneralCategory::NonspacingMark), ('\u{1cf30}', '\u{1cf46}',
        ...
        ('\u{1e5ff}', '\u{1e5ff}', GeneralCategory::OtherPunctuation), ('\u{1e6c0}', '\u{1e6de}',
        GeneralCategory::OtherLetter), ('\u{1e6e0}', '\u{1e6e2}', GeneralCategory::OtherLetter),
        ('\u{1e6e3}', '\u{1e6e3}', GeneralCategory::NonspacingMark), ('\u{1e6e4}', '\u{1e6e5}',
        GeneralCategory::OtherLetter), ('\u{1e6e6}', '\u{1e6e6}', GeneralCategory::NonspacingMark),
        ('\u{1e6e7}', '\u{1e6ed}', GeneralCategory::OtherLetter), ('\u{1e6ee}', '\u{1e6ef}',
        GeneralCategory::NonspacingMark), ('\u{1e6f0}', '\u{1e6f4}', GeneralCategory::OtherLetter),
        ('\u{1e6f5}', '\u{1e6f5}', GeneralCategory::NonspacingMark), ('\u{1e6fe}', '\u{1e6fe}',
        GeneralCategory::OtherLetter), ('\u{1e6ff}', '\u{1e6ff}', GeneralCategory::ModifierLetter),
        ('\u{1e7e0}', '\u{1e7e6}', GeneralCategory::OtherLetter), ('\u{1e7e8}', '\u{1e7eb}',
        GeneralCategory::OtherLetter), ('\u{1e7ed}', '\u{1e7ee}', GeneralCategory::OtherLetter),
        ('\u{1e7f0}', '\u{1e7fe}', GeneralCategory::OtherLetter), ('\u{1e800}', '\u{1e8c4}',
        GeneralCategory::OtherLetter), ('\u{1e8c7}', '\u{1e8cf}', GeneralCategory::OtherNumber),
        ('\u{1e8d0}', '\u{1e8d6}', GeneralCategory::NonspacingMark), ('\u{1e900}', '\u{1e921}',
        ...
        ('\u{1f3fb}', '\u{1f3ff}', GeneralCategory::ModifierSymbol), ('\u{1f400}', '\u{1f6d8}',
        GeneralCategory::OtherSymbol), ('\u{1f6dc}', '\u{1f6ec}', GeneralCategory::OtherSymbol),
        ('\u{1f6f0}', '\u{1f6fc}', GeneralCategory::OtherSymbol), ('\u{1f700}', '\u{1f7d9}',
        GeneralCategory::OtherSymbol), ('\u{1f7e0}', '\u{1f7eb}', GeneralCategory::OtherSymbol),
        ('\u{1f7f0}', '\u{1f7f0}', GeneralCategory::OtherSymbol), ('\u{1f800}', '\u{1f80b}',
        GeneralCategory::OtherSymbol), ('\u{1f810}', '\u{1f847}', GeneralCategory::OtherSymbol),
        ('\u{1f850}', '\u{1f859}', GeneralCategory::OtherSymbol), ('\u{1f860}', '\u{1f887}',
        GeneralCategory::OtherSymbol), ('\u{1f890}', '\u{1f8ad}', GeneralCategory::OtherSymbol),
        ('\u{1f8b0}', '\u{1f8bb}', GeneralCategory::OtherSymbol), ('\u{1f8c0}', '\u{1f8c1}',
        GeneralCategory::OtherSymbol), ('\u{1f8d0}', '\u{1f8d8}', GeneralCategory::MathSymbol),
        ('\u{1f900}', '\u{1fa57}', GeneralCategory::OtherSymbol), ('\u{1fa60}', '\u{1fa6d}',
        GeneralCategory::OtherSymbol), ('\u{1fa70}', '\u{1fa7c}', GeneralCategory::OtherSymbol),
        ('\u{1fa80}', '\u{1fa8a}', GeneralCategory::OtherSymbol), ('\u{1fa8e}', '\u{1fac6}',
        GeneralCategory::OtherSymbol), ('\u{1fac8}', '\u{1fac8}', GeneralCategory::OtherSymbol),
        ('\u{1facd}', '\u{1fadc}', GeneralCategory::OtherSymbol), ('\u{1fadf}', '\u{1faea}',
        GeneralCategory::OtherSymbol), ('\u{1faef}', '\u{1faf8}', GeneralCategory::OtherSymbol),
        ('\u{1fb00}', '\u{1fb92}', GeneralCategory::OtherSymbol), ('\u{1fb94}', '\u{1fbef}',
        GeneralCategory::OtherSymbol), ('\u{1fbf0}', '\u{1fbf9}', GeneralCategory::DecimalNumber),
        ('\u{1fbfa}', '\u{1fbfa}', GeneralCategory::OtherSymbol), ('\u{20000}', '\u{2a6df}',
        GeneralCategory::OtherLetter), ('\u{2a700}', '\u{2b81d}', GeneralCategory::OtherLetter),
        ('\u{2b820}', '\u{2cead}', GeneralCategory::OtherLetter), ('\u{2ceb0}', '\u{2ebe0}',
        GeneralCategory::OtherLetter), ('\u{2ebf0}', '\u{2ee5d}', GeneralCategory::OtherLetter),
        ('\u{2f800}', '\u{2fa1d}', GeneralCategory::OtherLetter), ('\u{30000}', '\u{3134a}',
        GeneralCategory::OtherLetter), ('\u{31350}', '\u{33479}', GeneralCategory::OtherLetter),
        ('\u{e0001}', '\u{e0001}', GeneralCategory::Format), ('\u{e0020}', '\u{e007f}',
        GeneralCategory::Format), ('\u{e0100}', '\u{e01ef}', GeneralCategory::NonspacingMark),
        ('\u{f0000}', '\u{ffffd}', GeneralCategory::PrivateUse), ('\u{100000}', '\u{10fffd}',
        GeneralCategory::PrivateUse)
    ];
...
pub mod emoji {
    ...
    const EMOJI_STATUS: &[(char, char, EmojiStatus)] = &[
        ...
        ('\u{1f6d6}', '\u{1f6d7}', EmojiStatus::EmojiPresentation), ('\u{1f6d8}', '\u{1f6d8}',
        EmojiStatus::EmojiPresentation), ('\u{1f6d9}', '\u{1f6db}', EmojiStatus::NonEmoji),
        ('\u{1f6dc}', '\u{1f6dc}', EmojiStatus::EmojiPresentation), ('\u{1f6dd}', '\u{1f6df}',
        EmojiStatus::EmojiPresentation), ('\u{1f6e0}', '\u{1f6e5}', EmojiStatus::EmojiOther),
        ('\u{1f6e6}', '\u{1f6e8}', EmojiStatus::NonEmoji), ('\u{1f6e9}', '\u{1f6e9}',
        EmojiStatus::EmojiOther), ('\u{1f6ea}', '\u{1f6ea}', EmojiStatus::NonEmoji), ('\u{1f6eb}',
        '\u{1f6ec}', EmojiStatus::EmojiPresentation), ('\u{1f6ed}', '\u{1f6ef}',
        ...
        EmojiStatus::EmojiPresentation), ('\u{1fa8a}', '\u{1fa8a}', EmojiStatus::EmojiPresentation),
        ('\u{1fa8b}', '\u{1fa8d}', EmojiStatus::NonEmoji), ('\u{1fa8e}', '\u{1fa8e}',
        EmojiStatus::EmojiPresentation), ('\u{1fa8f}', '\u{1fa8f}', EmojiStatus::EmojiPresentation),
        ('\u{1fa90}', '\u{1fa95}', EmojiStatus::EmojiPresentation), ('\u{1fa96}', '\u{1faa8}',
        EmojiStatus::EmojiPresentation), ('\u{1faa9}', '\u{1faac}', EmojiStatus::EmojiPresentation),
        ('\u{1faad}', '\u{1faaf}', EmojiStatus::EmojiPresentation), ('\u{1fab0}', '\u{1fab6}',
        EmojiStatus::EmojiPresentation), ('\u{1fab7}', '\u{1faba}', EmojiStatus::EmojiPresentation),
        ('\u{1fabb}', '\u{1fabd}', EmojiStatus::EmojiPresentation), ('\u{1fabe}', '\u{1fabe}',
        EmojiStatus::EmojiPresentation), ('\u{1fabf}', '\u{1fabf}', EmojiStatus::EmojiPresentation),
        ('\u{1fac0}', '\u{1fac2}', EmojiStatus::EmojiPresentation), ('\u{1fac3}', '\u{1fac5}',
        EmojiStatus::EmojiPresentationAndModifierBase), ('\u{1fac6}', '\u{1fac6}',
        EmojiStatus::EmojiPresentation), ('\u{1fac7}', '\u{1fac7}', EmojiStatus::NonEmoji),
        ('\u{1fac8}', '\u{1fac8}', EmojiStatus::EmojiPresentation), ('\u{1fac9}', '\u{1facc}',
        EmojiStatus::NonEmoji), ('\u{1facd}', '\u{1facd}', EmojiStatus::EmojiPresentation),
        ...
        ('\u{1fae9}', '\u{1fae9}', EmojiStatus::EmojiPresentation), ('\u{1faea}', '\u{1faea}',
        EmojiStatus::EmojiPresentation), ('\u{1faeb}', '\u{1faee}', EmojiStatus::NonEmoji),
        ('\u{1faef}', '\u{1faef}', EmojiStatus::EmojiPresentation), ('\u{1faf0}', '\u{1faf6}',
