//! GPU-vs-CPU parity harness for the Whisper engine (`makepad_ai_speech::whisper`).
//!
...
use makepad_ai_speech::whisper::{Segment, WhisperModel, WhisperParams, WhisperState};
...
fn run_once(
    ...
    makepad_ai_speech::whisper::set_accel_enabled(accel);
    let backend = makepad_ai_speech::whisper::accel_backend_name();
    // Drop anything a previous pass left behind.
    let _ = makepad_ai_speech::whisper::take_token_trace();
    ...
    Run {
        ...
        backend,
        seconds,
        tokens: makepad_ai_speech::whisper::take_token_trace(),
        segments,
    }
}
