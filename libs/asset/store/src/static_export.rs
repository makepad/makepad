...
fn export_into(
    ...
    for root in &kept_roots {
        ...
        search_values.push(obj(vec![
            ...
            ("artist", s(search.artist.clone())),
            ("artist_url", s(search.artist_url.clone())),
            ("album", s(search.album.clone())),
            ("source_url", s(search.source_url.clone())),
            ("license", s(search.license.clone())),
            ("license_url", s(search.license_url.clone())),
