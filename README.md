...
Rendering in makepad is done using Shaders written in Rust. For an example look up render/src/quad.rs This is the most basic render primitive, 2 triangles in a rectangular shape with a fixed color. If you look at the widget/src/button.rs widget you see you can override these shader functions for localised parameterisable styling.
