...
pub fn update_adler32(adler: u32, data: &[u8]) -> u32 {
    let mut hash = crate::lode_png::miniz_oxide::adler32::Adler32::from_checksum(adler);
...
#[cfg(feature = "simd")]
pub fn update_adler32(adler: u32, data: &[u8]) -> u32 {
    let mut hash = crate::miniz_oxide::adler32::simd_adler32::Adler32::from_checksum(adler);
    hash.write(data);
    hash.finish()
}*/
