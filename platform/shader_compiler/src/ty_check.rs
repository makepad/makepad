    ...
    fn ty_check_bin_expr(
        ...
        match op {
            ...
            BinOp::AddAssign | BinOp::SubAssign | BinOp::DivAssign => match (&left_ty, &right_ty) {
                ...
                (Ty::Vec2f, Ty::Float) => Some(Ty::Vec2f),
                (Ty::Vec2f, Ty::Vec2f) => Some(Ty::Vec2f),
                (Ty::Vec3f, Ty::Float) => Some(Ty::Vec3f),
                (Ty::Vec3f, Ty::Vec3f) => Some(Ty::Vec3f),
                (Ty::Vec4f, Ty::Float) => Some(Ty::Vec4f),
                (Ty::Vec4f, Ty::Vec4f) => Some(Ty::Vec4f),
                (Ty::Mat2, Ty::Float) => Some(Ty::Mat2),
                (Ty::Mat2, Ty::Mat2) => Some(Ty::Mat2),
                (Ty::Mat3, Ty::Float) => Some(Ty::Mat3),
                (Ty::Mat3, Ty::Mat3) => Some(Ty::Mat3),
                (Ty::Mat4f, Ty::Float) => Some(Ty::Mat4f),
                (Ty::Mat4f, Ty::Mat4f) => Some(Ty::Mat4f),
                _ => None,
            },
            BinOp::MulAssign => match (&left_ty, &right_ty) {
                ...
                (Ty::Vec2f, Ty::Float) => Some(Ty::Vec2f),
                (Ty::Vec2f, Ty::Vec2f) => Some(Ty::Vec2f),
                (Ty::Vec2f, Ty::Mat2) => Some(Ty::Vec2f),
                (Ty::Vec3f, Ty::Float) => Some(Ty::Vec3f),
                (Ty::Vec3f, Ty::Vec3f) => Some(Ty::Vec3f),
                (Ty::Vec3f, Ty::Mat3) => Some(Ty::Vec3f),
                (Ty::Vec4f, Ty::Float) => Some(Ty::Vec4f),
                (Ty::Vec4f, Ty::Vec4f) => Some(Ty::Vec4f),
                (Ty::Vec4f, Ty::Mat4f) => Some(Ty::Vec4f),
                (Ty::Mat2, Ty::Float) => Some(Ty::Mat2),
                (Ty::Mat2, Ty::Mat2) => Some(Ty::Mat2),
                (Ty::Mat3, Ty::Float) => Some(Ty::Mat3),
                (Ty::Mat3, Ty::Mat3) => Some(Ty::Mat3),
            ...
            BinOp::Eq | BinOp::Ne => match (&left_ty, &right_ty) {
                ...
                (Ty::Vec2f, Ty::Vec2f) => Some(Ty::Bool),
                (Ty::Vec3f, Ty::Vec3f) => Some(Ty::Bool),
                (Ty::Vec4f, Ty::Vec4f) => Some(Ty::Bool),
                (Ty::Mat2, Ty::Mat2) => Some(Ty::Bool),
                (Ty::Mat3, Ty::Mat3) => Some(Ty::Bool),
                (Ty::Mat4f, Ty::Mat4f) => Some(Ty::Bool),
                _ => None,
            },
            ...
            BinOp::Add | BinOp::Sub | BinOp::Div => match (&left_ty, &right_ty) {
                (Ty::Int, Ty::Int) => Some(Ty::Int),
                (Ty::Float, Ty::Float) => Some(Ty::Float),
                (Ty::Float, Ty::Vec2f) => Some(Ty::Vec2f),
                (Ty::Float, Ty::Vec3f) => Some(Ty::Vec3f),
                (Ty::Float, Ty::Vec4f) => Some(Ty::Vec4f),
                (Ty::Float, Ty::Mat2) => Some(Ty::Mat2),
                (Ty::Float, Ty::Mat3) => Some(Ty::Mat3),
                (Ty::Float, Ty::Mat4f) => Some(Ty::Mat4f),
                (Ty::Ivec2, Ty::Int) => Some(Ty::Ivec2),
                (Ty::Ivec2, Ty::Ivec2) => Some(Ty::Ivec2),
                (Ty::Ivec3, Ty::Int) => Some(Ty::Ivec3),
                (Ty::Ivec3, Ty::Ivec3) => Some(Ty::Ivec3),
            ...
            BinOp::Mul => match (&left_ty, &right_ty) {
                ...
                (Ty::Vec4f, Ty::Mat4f) => Some(Ty::Vec4f),
                (Ty::Mat2, Ty::Float) => Some(Ty::Mat2),
                (Ty::Mat2, Ty::Vec2f) => Some(Ty::Vec2f),
                (Ty::Mat2, Ty::Mat2) => Some(Ty::Mat2),
                (Ty::Mat3, Ty::Float) => Some(Ty::Mat3),
                (Ty::Mat3, Ty::Vec3f) => Some(Ty::Vec3f),
                (Ty::Mat3, Ty::Mat3) => Some(Ty::Mat3),
                (Ty::Mat4f, Ty::Float) => Some(Ty::Mat4f),
                (Ty::Mat4f, Ty::Vec4f) => Some(Ty::Vec4f),
                (Ty::Mat4f, Ty::Mat4f) => Some(Ty::Mat4f),
                _ => None,
            },
        }
    ...
    fn ty_check_un_expr(&mut self, span: TokenSpan, op: UnOp, expr: &Expr) -> Result<Ty, LiveError> {
        ...
        match op {
            ...
            UnOp::Neg => match ty {
                ...
                Ty::Vec2f => Some(Ty::Vec2f),
                Ty::Vec3f => Some(Ty::Vec3f),
                Ty::Vec4f => Some(Ty::Vec4f),
                _ => None,
            },
        }
        .ok_or_else( || LiveError {
    ...
    */
        ...
        match ty {
            ref ty if ty.is_vector() => {
                ...
                Ok(match ty {
                    ...
                    Ty::Vec2f | Ty::Vec3f | Ty::Vec4f => match swizzle.len() {
                        1 => Ty::Float,
                        2 => Ty::Vec2f,
                        3 => Ty::Vec3f,
                        4 => Ty::Vec4f,
    ...
    fn ty_check_index_expr(
        ...
        let elem_ty = match ty {
            ...
            Ty::Vec2f | Ty::Vec3f | Ty::Vec4f => Ty::Float,
            Ty::Mat2 => Ty::Vec2f,
            Ty::Mat3 => Ty::Vec3f,
            Ty::Mat4f => Ty::Vec4f,
            _ => {
