...
pub struct Cx2da<'a> {
    ...
    pub turtles: Vec<Turtle2>,
    pub turtle_walks: Vec<TurtleWalk>,
    pub align_list: Vec<Area>,
    pub current_dpi_factor: f32,
}

impl<'a> Deref for Cx2da<'a> {type Target = Cx; fn deref(&self) -> &Self::Target {self.cx}}
impl<'a> DerefMut for Cx2da<'a> {fn deref_mut(&mut self) -> &mut Self::Target {self.cx}}
...
impl<'a> Cx2da<'a> {
    ...
    pub fn view_will_redraw(&self, view: &View2) -> bool {
