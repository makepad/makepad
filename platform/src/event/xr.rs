...
impl XrHand{
    ...
    pub const THUMB_FIST: usize = 3;
    pub const THUMB_KNUCKLE: usize = 4;
    pub const THUMB_TIP: usize = 5;
    pub const INDEX_BASE: usize = 6;
    pub const INDEX_FIST: usize = 7;
    pub const INDEX_KNUCKLE1: usize = 8;
    pub const INDEX_KNUCKLE2: usize = 9;
    pub const INDEX_TIP: usize = 10;
    pub const MIDDLE_BASE: usize = 11;
    pub const MIDDLE_FIST: usize = 12;
    pub const MIDDLE_KNUCKLE1: usize = 13;
    pub const MIDDLE_KNUCKLE2: usize = 14;
    pub const MIDDLE_TIP: usize = 15;
    pub const RING_BASE: usize = 16;
    pub const RING_FIST: usize = 17;
    pub const RING_KNUCKLE1: usize = 18;
    pub const RING_KNUCKLE2: usize = 19;
    pub const RING_TIP: usize = 20;
    pub const PINKY_BASE: usize = 21;
    pub const PINKY_FIST: usize = 22;
    pub const PINKY_KNUCKLE1: usize = 23;
    pub const PINKY_KNUCKLE2: usize = 24;
