...
pub fn force_software_av1() -> bool {
    std::env::var_os("MAKEPAD_FORCE_SOFTWARE_AV1").is_some()
}

pub fn force_native_av1() -> bool {
    std::env::var_os("MAKEPAD_FORCE_NATIVE_AV1").is_some()
}

/// Android canPlayType table.
/// Native path is MediaPlayer/MediaCodec via Java + software AV1 fallback in Rust.
