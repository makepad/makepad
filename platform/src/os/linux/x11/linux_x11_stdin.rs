...
impl Cx {
    ...
    pub (crate) fn stdin_handle_repaint(&mut self, _opengl_cx: &mut OpenglCx) {
    ...
    pub fn stdin_event_loop(&mut self, opengl_cx: &mut OpenglCx) {
    ...
    fn stdin_handle_platform_ops(&mut self, _opengl_cx: &OpenglCx, main_texture: &Texture) {
