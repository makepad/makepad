...
pub(crate) fn hr_err(context: &str, err: crate::windows::core::Error) -> VideoFileError {
    ...
    pub fn new(path: &str, options: &VideoFileEncoderOptions) -> Result<Self, VideoFileError> {
        ...
        unsafe {
            ...
            match &transform_info {
                ...
                None => crate::log!("video file encoder: video transform not reported by sink writer"),
            }
