...
fn main() {
    ...
    println!("cargo:rustc-check-cfg=cfg(apple_bundle,apple_sim,lines,linux_direct,no_android_choreographer,ohos_sim,use_unstable_unix_socket_ancillary_data_2021)");
