...
pub fn write_context(release: &Release, environment: &Environment) -> Result<PathBuf, String> {
    ...
    fs::write(&context, format!(
        ...
        This process already has the private Rust, Cargo home, build directory, Microsoft SDK include/library paths and bundled LLD linker in its environment. Use these; do not install another compiler, change global PATH, or run rustup.\n\
