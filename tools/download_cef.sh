...
usage() {
    cat <<'EOF'
Usage: ./tools/download_cef.sh [options]
...
Examples:
  ...
  ./tools/download_cef.sh --platform macosarm64
  ./tools/download_cef.sh --platform all --type standard
  ./tools/download_cef.sh --platform windows64,linux64 --channel beta
EOF
}
