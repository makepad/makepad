...
output_img = "cathedral_test2.png"
...
def run_test(params):
    ...
    mse, mae, corr = calculate_metrics(target_img, output_img)
    return mse, mae, corr

tests = [
    {"AO_STRENGTH": 1.0, "SHADOW_STRENGTH": 0.8, "TONE_GAMMA": 0.6, "TONE_GAIN": 0.8},
    {"AO_STRENGTH": 1.2, "SHADOW_STRENGTH": 1.0, "TONE_GAMMA": 0.5, "TONE_GAIN": 0.7},
    {"AO_STRENGTH": 1.5, "SHADOW_STRENGTH": 1.2, "TONE_GAMMA": 0.45, "TONE_GAIN": 0.6},
]
