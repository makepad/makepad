...
def run_relay(
    ...
    *,
    ...
    on_json_line: called for each parsed JSON line from merged subprocess stdout/stderr
    on_nonjson_line: called for each non-JSON line from merged subprocess stdout/stderr
    ...
    # App-specific control env vars must be allowed to override the generic one.
    proc_env.setdefault("MAKEPAD_EVENTS", "1")
