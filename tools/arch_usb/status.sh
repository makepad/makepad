...
printf '\nServices:\n'
printf 'sshd.service active=%s enabled=%s\n' "$(systemctl is-active sshd.service || true)" "$(systemctl is-enabled sshd.service || true)"
printf 'SSH: sudo makepad-ssh show | enable | disable | reset-password\n'
