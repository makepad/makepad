...
live_design!{
   ...
   /*  const THEME_COLOR_GENERATOR = #F6EB14ff
    ...
    const THEME_COLOR_GENERATOR_DARK = (hsvmod(THEME_COLOR_GENERATOR, 0.,0.,-0.4))
    const THEME_COLOR_EFFECT_DARK = (hsvmod(THEME_COLOR_EFFECT,  0.,0.,-0.4))
    const THEME_COLOR_MODULATION_DARK =(hsvmod(THEME_COLOR_MODULATION,  0.,0.,-0.4))
    const THEME_COLOR_FILTER_DARK = (hsvmod(THEME_COLOR_FILTER,  0.,0.,-0.4))
    const THEME_COLOR_ENVELOPE_DARK = (hsvmod(THEME_COLOR_ENVELOPE,  0.,0.,-0.4))
    const THEME_COLOR_META_DARK = (hsvmod(THEME_COLOR_META,  0.,0.,-0.4))
    const THEME_COLOR_UTILITY_DARK = (hsvmod(THEME_COLOR_UTILITY,  0.,0.,-0.4)) 



    const THEME_COLOR_GENERATOR_FADE = (hsvmod(THEME_COLOR_GENERATOR, 0.,-0.3,0.3))
    const THEME_COLOR_EFFECT_FADE = (hsvmod(THEME_COLOR_EFFECT, 0.,-0.3,0.3))
    const THEME_COLOR_MODULATION_FADE =(hsvmod(THEME_COLOR_MODULATION, 0.,-0.3,0.3))
    const THEME_COLOR_FILTER_FADE = (hsvmod(THEME_COLOR_FILTER, 0.,-0.3,0.3))
    const THEME_COLOR_ENVELOPE_FADE = (hsvmod(THEME_COLOR_ENVELOPE, 0.,-0.3,0.3))
    const THEME_COLOR_META_FADE = (hsvmod(THEME_COLOR_META, 0.,-0.3,0.3))
    const THEME_COLOR_UTILITY_FADE = (hsvmod(THEME_COLOR_UTILITY, 0.,-0.3,0.3))
