...
live_design!{
    ...
    const THEME_COLOR_GENERATOR = #F6EB14
    const THEME_COLOR_EFFECT = #4992CE
    const THEME_COLOR_MODULATION = #F15751
    const THEME_COLOR_FILTER = #3A3A97
    const THEME_COLOR_ENVELOPE = #EDAD3A
    const THEME_COLOR_META = #D9FF7F
    const THEME_COLOR_UTILITY = #909090


    const THEME_COLOR_GENERATOR_FADE = blend(THEME_COLOR_GENERATOR, COLOR_UP_3)
    const THEME_COLOR_EFFECT_FADE = blend(THEME_COLOR_EFFECT, COLOR_UP_3)
    const THEME_COLOR_MODULATION_FADE =blend(THEME_COLOR_MODULATION, COLOR_UP_3)
    const THEME_COLOR_FILTER_FADE = blend(THEME_COLOR_FILTER, COLOR_UP_3)
    const THEME_COLOR_ENVELOPE_FADE = blend(THEME_COLOR_ENVELOPE, COLOR_UP_3)
    const THEME_COLOR_META_FADE = blend(THEME_COLOR_META, COLOR_UP_3)
    const THEME_COLOR_UTILITY_FADE = blend(THEME_COLOR_UTILITY, COLOR_UP_3)
