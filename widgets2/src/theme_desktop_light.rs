...
script_mod!{
    ...
    mod.themes.light = {
        ...
        color_u_3: mix(me.color_w, me.color_w_h, pow(0.8, me.color_contrast))
        ...
        color_d_025: mix(me.color_b, me.color_b_h, pow(0.965, me.color_contrast))
        color_d_05: mix(me.color_b, me.color_b_h, pow(0.925, me.color_contrast))
        color_d_075: mix(me.color_b, me.color_b_h, pow(0.9, me.color_contrast))
        color_d_1: mix(me.color_b, me.color_b_h, pow(0.875, me.color_contrast))
        ...
        color_bg_app: mix(
            ...
            pow(0.15, me.color_contrast))
        color_fg_app: mix(
            me.color_w * mix(#ffffff, me.color_tint, me.color_tint_amount),
            me.color_b * mix(#ffffff, me.color_tint, me.color_tint_amount),
            pow(0.175, me.color_contrast))
        ...
        color_opaque_d_05: mix(me.color_fg_app, #0, 0.05)
        ...
        color_shadow: me.color_d_1
        color_shadow_focus: me.color_d_2
        color_shadow_disabled: me.color_d_1
        color_shadow_flat: me.color_d_1
        color_shadow_flat_disabled: me.color_opaque_d_1
        color_light: me.color_u_4
        color_light_hover: me.color_u_5
        color_light_focus: me.color_u_5
        color_light_disabled: me.color_u_4

        color_flat_focus: me.color_d_2
        ...
        color_highlight: me.color_d_1
        color_text_cursor: me.color_white
        color_bg_highlight_inline: me.color_d_1

        color_text: me.color_d_4
        color_text_val: me.color_d_2
        color_text_hl: me.color_text
        color_text_hover: me.color_text
        color_text_focus: me.color_text
        color_text_down: me.color_text
        color_text_disabled: me.color_d_1
        color_text_placeholder: me.color_d_3
        color_text_placeholder_hover: me.color_d_3
        color_text_meta: me.color_d_3

        color_label_inner: me.color_d_4
        color_label_inner_down: me.color_d_5
        ...
        color_label_inner_inactive: me.color_d_3
        color_label_inner_disabled: me.color_d_1

        color_label_outer: me.color_d_5
        color_label_outer_off: me.color_d_3
        ...
        color_label_outer_disabled: me.color_d_1

        color_bg_container: me.color_u_3 * 0.8
        ...
        color_bevel_inset_1_focus: me.color_shadow_focus
        ...
        color_inset_1: me.color_d_1
        color_inset_1_hover: me.color_d_2
        ...
        color_inset_1_drag: me.color_inset_1_hover
        color_inset_1_empty: me.color_u_hidden
        color_inset_1_disabled: me.color_d_025

        color_inset_2: me.color_d_05
        color_inset_2_hover: me.color_d_1
        ...
        color_inset_2_drag: me.color_inset_2_hover
        color_inset_2_disabled: me.color_d_025
        color_inset_2_empty: me.color_inset_2

        // WIDGET COLORS
        color_outset: me.color_u_3
        color_outset_down: me.color_u_1
        color_outset_hover: me.color_u_4
        color_outset_active: me.color_u_5
        color_outset_focus: me.color_outset
        color_outset_drag: me.color_outset_hover
        color_outset_disabled: me.color_u_1
        color_outset_inactive: me.color_d_hidden

        color_outset_1: me.color_u_4
        color_outset_1_down: me.color_d_2
        color_outset_1_drag: me.color_outset_1_down
        color_outset_1_hover: me.color_outset_1
        color_outset_1_active: me.color_u_6
        color_outset_1_focus: me.color_outset_1
        color_outset_1_disabled: me.color_u_1

        color_outset_2: me.color_u_hidden
        color_outset_2_down: me.color_d_hidden
        color_outset_2_hover: me.color_u_2
        color_outset_2_drag: me.color_outset_2_down
        color_outset_2_active: me.color_u_4
        color_outset_2_focus: me.color_outset_2_hover
        color_outset_2_disabled: me.color_u_1

        color_icon: me.color_u_2
        color_icon_inactive: me.color_inset
        color_icon_active: me.color_d_4
        color_icon_disabled: me.color_u_1

        color_mark: me.color_d_4
        color_mark_empty: me.color_inset
        color_mark_off: me.color_d_hidden
        ...
        color_mark_down: me.color_d_3
        color_mark_disabled: me.color_d_hidden

        color_selection: me.color_u_hidden
        color_selection_hover: me.color_d_2
        color_selection_down: me.color_d_2
        color_selection_focus: me.color_d_2
        color_selection_empty: me.color_u_hidden
        color_selection_disabled: me.color_u_hidden

        // Progress bars, slider amounts etc.
        color_val: me.color_opaque_d_3
        color_val_hover: me.color_opaque_d_4
        color_val_focus: me.color_val_hover
        color_val_drag: me.color_val_hover
        color_val_disabled: me.color_d_hidden

        color_val_1: me.color_opaque_d_3
        color_val_1_hover: me.color_opaque_d_4
        color_val_1_focus: me.color_val_1_hover
        color_val_1_drag: me.color_val_1_hover
        color_val_1_disabled: me.color_d_hidden
        
        color_val_2: me.color_opaque_d_3
        color_val_2_hover: me.color_opaque_d_4
        color_val_2_focus: me.color_val_2_hover
        color_val_2_drag: me.color_val_2_hover
        color_val_2_disabled: me.color_d_hidden


        // WIDGET SPECIFIC COLORS
        color_handle: me.color_opaque_u_4
        color_handle_hover: me.color_handle
        color_handle_focus: me.color_handle
        color_handle_disabled: me.color_opaque_u_1
        color_handle_drag: me.color_handle

        color_handle_1: me.color_opaque_u_6
        color_handle_1_hover: me.color_w
        color_handle_1_focus: me.color_handle_1_hover
        color_handle_1_disabled: me.color_opaque_u_1
        color_handle_1_drag: me.color_handle_1_hover

        color_handle_2: me.color_opaque_u_1
        color_handle_2_hover: me.color_opaque_u_1
        color_handle_2_focus: me.color_handle_2_hover
        color_handle_2_disabled: me.color_opaque_u_1
        color_handle_2_drag: me.color_handle_2_hover
